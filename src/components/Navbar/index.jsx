...
export default function Navbar() {
  ...
  return (
    <nav className={`${show ? 'animate-fade-down animate-duration-[500ms] animate-ease-linear opacity-100 h-fit' : 'opacity-0 h-0'} bg-gradient-to-b from-custom-blue-dark from-1% to-transparent w-full flex justify-between items-center p-4 lg:px-8 text-custom-beige text-sm lg:text-base fixed top-0 left-0 z-10 transition-all duration-500`}>
